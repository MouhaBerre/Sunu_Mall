...
export const Route = createFileRoute("/screens/driver-login")({ component: DriverLogin });
    ...
    <div className="flex justify-center py-6">
      <PhoneFrame label="13 — Connexion Livreur">
        ...
        <div className="px-6 pt-6 space-y-4 fade-in-up">
          ...
          <Link to="/screens/driver-dashboard" className="btn-orange block text-center rounded-xl py-3 text-sm font-bold">
            Se connecter
          </Link>
