...
export const Route = createFileRoute("/screens/add-product")({ component: AddProduct });
        ...
        <div className="space-y-6">
          <div className="surface-card p-6">
            ...
            <div className="mt-4 grid grid-cols-4 gap-3">
              {[0, 1, 2].map((i) => (
                <div key={i} className="aspect-square rounded-lg bg-gradient-to-br from-navy to-navy-2 border border-border" />
              ))}
              <div className="aspect-square rounded-lg border-2 border-dashed border-border grid place-items-center text-muted-foreground text-xs">+</div>
            </div>
          </div>
