...
export const Route = createFileRoute("/screens/admin-managers")({ component: AdminManagers });
      ...
      <div className="surface-card overflow-hidden">
        ...
        <div className="flex items-center justify-between border-t border-border px-6 py-3 text-xs text-muted-foreground">
          ...
          <div className="flex gap-1">
            <button className="rounded-md border border-border px-3 py-1">Précédent</button>
            <button className="rounded-md bg-navy px-3 py-1 text-white">1</button>
            <button className="rounded-md border border-border px-3 py-1">2</button>
            <button className="rounded-md border border-border px-3 py-1">Suivant</button>
          </div>
        </div>
      </div>
    </DashboardShell>
